...
public class SelectSortStart {
    ...
    public static void main(String[] args) {
        ...
        SelectSort.SelectionSort arr2 = new SelectionSort(100);
        ...
        SelectSort.SelectionSort arr3 = new SelectionSort(5000);
        ...
        SelectSort.SelectionSort arrOpti = new SelectionSort(5000);
